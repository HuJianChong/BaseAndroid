...
/**
 * 获取运营商、网络类型工具类 相关权限<uses-permission
 * android:name="android.permission.READ_PHONE_STATE"/> <uses-permission
 * android:name="android.permission.ACCESS_NETWORK_STATE"/>
 * 如果允许放system/apps下面，则可以加权限<uses-permission
 * android:name="android.permission.WRITE_APN_SETTINGS"/>能更准确
 * 
...
public class GetMobileNetInfoUtils {
	...
	private GetMobileNetInfoUtils() {
		/* cannot be instantiated */
		throw new UnsupportedOperationException("GetMobileNetInfoUtils cannot be instantiated");
	}
