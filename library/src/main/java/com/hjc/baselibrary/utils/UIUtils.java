...
public class UIUtils {
    ...
    public static Bitmap captureContent(Activity activity) {
        ...
        contentLayout.getChildAt(0).getWindowVisibleDisplayFrame(contentFrame);
        int contentHeight = contentFrame.height();

        //TODO modify by Johnny
        // 获取屏幕长和高
        ...
        Bitmap b = null;
        try {
            b = Bitmap.createBitmap(b1, 0, statusBarHeight, b1.getWidth(), contentHeight);
            view.destroyDrawingCache();
